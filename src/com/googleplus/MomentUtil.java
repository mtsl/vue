...
public class MomentUtil {
    ...
    static {
        ...
        for (int i = 0; i < count; i++) {
            VISIBLE_ACTIVITIES[i] = "http://schemas.google.com/"
                    + VISIBLE_ACTIVITIES[i];
        }
    }
    ...
    private static ItemScope getCommentActivityResult() {
        return new ItemScope.Builder()
                ...
                .setText("I can't wait to use it on my site!").build();
    }
    ...
    private static ItemScope getReserveActivityResult() {
        return new ItemScope.Builder()
                ...
                .setStartDate("2012-06-28T19:00:00-08:00").setAttendeeCount(3)
                .build();
    }
    ...
    private static ItemScope getReviewActivityResult() {
        ItemScope rating = new ItemScope.Builder()
                .setType("http://schema.org/Rating").setRatingValue("100")
                .setBestRating("100").setWorstRating("0").build();
        ...
        return new ItemScope.Builder()
                ...
                .setText("It is amazingly effective").setReviewRating(rating)
                .build();
    }
}