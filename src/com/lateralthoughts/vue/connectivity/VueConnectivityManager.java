...
public class VueConnectivityManager {
    ...
    /**
     * Check if the network connection is available, it takes the user
     * preferences stored in SharedPreferences.
     * 
     * @param context
     *            Context.
     * @param isWifi
     *            boolean. if true then checks for wifi connectivity else checks
    ...
    private static boolean checkConnection(Context context, boolean isWifi) {
        ...
        if (isNetworkConnected && !isConnectionFast(type, subType)) {
            try {
                Toast.makeText(context, "Netowrk connection is slow",
