...
public class AisleManager {
	...
	public void createEmptyAisle(final Aisle aisle,
		...
		Log.i("imageurl", "imageurl  aisle creation request aisleAsString: "
				+ aisleAsString);
	...
	*/}
	...
	public void addImageToAisle(final boolean fromDetailsScreenFlag, VueImage image,
			final ImageAddedCallback callback) {
