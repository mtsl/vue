...
public class ContentBrowserAdapterFactory {
	
	private static ContentBrowserAdapterFactory sContentBrowserAdapterFactory = null;
	...
	private final int POOL_MAX_SIZE = 750;
	
	private Context mContext;
	public Drawable mEvenColumnBackground;
	public Drawable mOddColumnBackground;
	
	private ContentBrowserAdapterFactory(Context context){
	...
	public static ContentBrowserAdapterFactory getInstance(Context context){
		if(null == sContentBrowserAdapterFactory){
			sContentBrowserAdapterFactory = new ContentBrowserAdapterFactory(context);
		}
		return sContentBrowserAdapterFactory;
	}
