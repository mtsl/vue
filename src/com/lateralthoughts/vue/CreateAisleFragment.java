...
public class CreateAisleFragment extends Fragment {
  ...
  com.lateralthoughts.vue.utils.EditTextBackEvent lookingForText = null,
      occasionText = null, saySomethingAboutAisle = null, findAtText = null;
  ...
  RelativeLayout dataEntryBottomTopLayout = null,
      ...
      dataEntryInviteFriendsFacebookLayout = null, titleBarBottomLayout = null,
      actionBarTopLayout = null, dataEntryInviteFriendsCancelLayout = null,
  ...
  ImageView createAisleTitleBg = null, createAiselCloseBtn = null,
      ...
      addImageToAisle = null, createAisleTitleTopBg = null, findAtIcon = null,
      edit_aisle = null;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View v = inflater.inflate(R.layout.create_aisleview_fragment, container,
        false);
    ...
    shareCreatedAisle = (ImageView) v.findViewById(R.id.share_created_aisle);
        ...
        .setOnEditorActionListener(new EditText.OnEditorActionListener() {
          ...
          public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
            ...
            if (lookingForText.getText().toString().trim().length() > 0) {
              lookingForBigText.setText(lookingForText.getText().toString());
            }
            previousLookingfor = lookingForText.getText().toString();
            ...
            if (appInstalledOrNot(VueConstants.FACEBOOK_PACKAGE_NAME)) {
              ...
              if (aisleImagePathList != null) {
                ...
                for (int i = 0; i < aisleImagePathList.size(); i++) {
                  clsShare shareObj = new clsShare(null, aisleImagePathList
                      .get(i));
              ...
              Toast.makeText(getActivity(),
                  "Facebook Application was not installed.", Toast.LENGTH_LONG)
                  .show();
            }
          }
        });
        ...
        .setOnClickListener(new OnClickListener() {
          ...
          public void onClick(View arg0) {
            ...
            if (appInstalledOrNot(VueConstants.GOOGLEPLUS_PACKAGE_NAME)) {
              ...
              for (int i = 0; i < aisleImagePathList.size(); i++) {
                imageUris.add(Uri.fromFile(new File(aisleImagePathList.get(i))));
              }
              String shareText = "Your friend "
                  + ""
                  + " wants your opinion - get Vue to see the full details and help "
              ...
              sendIntent.setClassName(VueConstants.GOOGLEPLUS_PACKAGE_NAME,
                  activityname);
              getActivity().startActivityForResult(sendIntent,
                  VueConstants.SHARE_INTENT_REQUEST_CODE);
            } else {
              Toast.makeText(getActivity(),
                  "Google+ Application was not installed.", Toast.LENGTH_LONG)
                  .show();
            }
          }
        });
    ...
    createAiselToServer.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (!(lookingForBigText.getText().toString().trim().equals(LOOKING_FOR))
            && !(occassionBigText.getText().toString().trim().equals(OCCASION))) {
    ...
    shareCreatedAisle.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (aisleImagePathList != null) {
          ArrayList<clsShare> imageUrlList = new ArrayList<clsShare>();
          for (int i = 0; i < aisleImagePathList.size(); i++) {
            clsShare shareObj = new clsShare(null, aisleImagePathList.get(i));
            imageUrlList.add(shareObj);
          }
  ...
  public void createAisleClickFunctionality() {
    ...
    inputMethodManager.hideSoftInputFromWindow(
        saySomethingAboutAisle.getWindowToken(), 0);
    inputMethodManager
        .hideSoftInputFromWindow(occasionText.getWindowToken(), 0);
    inputMethodManager.hideSoftInputFromWindow(lookingForText.getWindowToken(),
        0);
    inputMethodManager.hideSoftInputFromWindow(findAtText.getWindowToken(), 0);
    lookingForPopup.setVisibility(View.GONE);
    ocassionPopup.setVisibility(View.GONE);
    categoeryPopup.setVisibility(View.GONE);
    findAtPopup.setVisibility(View.GONE);
