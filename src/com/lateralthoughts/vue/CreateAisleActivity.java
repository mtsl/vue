...
public class CreateAisleActivity extends BaseActivity {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    if (!isNewActionBar) {
      ...
      getSupportMenuInflater().inflate(R.menu.create_aisle_options2, menu);
    ...
    createAisleActivityRootLayout.getViewTreeObserver()
        .addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
          ...
          public void onGlobalLayout() {
            int heightDiff = createAisleActivityRootLayout.getRootView()
                .getHeight() - createAisleActivityRootLayout.getHeight();
