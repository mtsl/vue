...
public class Image {
    ...
    /**
     * Image rating like count is a read-only field for the client. So getter
     * should be disabled. This will disable serialization of the field.
     */
    @JsonIgnore
    ...
    /**
     * Comments are a read-only field for the client. So getter should be
