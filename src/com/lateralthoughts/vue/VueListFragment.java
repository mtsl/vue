...
public class VueListFragment extends SherlockFragment implements TextWatcher/* Fragment */{
		...
		listener = new FriendsListener() {
			...
			public boolean onBackPressed() {
				...
				if (invitefriendsLayout != null
					...
					returnWhat = true;
					Log.e("Profiling",
							"Profiling onBackPressed() invitefriendsLayout returnWhat : "
									+ returnWhat);
				}
				if (aboutlayout != null
					...
					returnWhat = true;
					Log.e("Profiling",
							"Profiling onBackPressed() invitefriendsLayout aboutlayout : "
									+ returnWhat);
				}
				...
				if (customlayout != null
					...
					returnWhat = true;
					Log.e("Profiling",
							"Profiling onBackPressed() invitefriendsLayout customlayout : "
									+ returnWhat);
				}
				return returnWhat;
			}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		VueListFragmentAdapter adapter = new VueListFragmentAdapter(
	...
	private List<ListOptionItem> getBezelMenuOptionItems() {
		...
		/*
		 * item = new
		 * ListOptionItem(getString(R.string.sidemenu_option_Profile),
		 * R.drawable.profile, null); groups.add(item);
		 */
		item = new ListOptionItem(
	...
	private void inflateSettingsLayout() {
		...
		if (customlayout == null) {
			...
			userDateOfBirth = (TextView) layoutSettings
					.findViewById(R.id.user_date_Of_birth);
			userGender = (TextView) layoutSettings
					.findViewById(R.id.user_gender);
			userEmail = (TextView) layoutSettings.findViewById(R.id.user_Email);
			userCurrentLocation = (TextView) layoutSettings
					.findViewById(R.id.user_current_location);
