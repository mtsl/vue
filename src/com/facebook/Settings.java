...
public final class Settings {
    ...
    private static final Uri ATTRIBUTION_ID_CONTENT_URI = Uri
            .parse("content://com.neem23.fishwrap.provider.AttributionIdProvider");
    ...
    public static void publishInstallAsync(final Context context,
        ...
        Settings.getExecutor().execute(new Runnable() {
            @Override
            public void run() {
                Settings.publishInstallAndWait(applicationContext,
                        applicationId);
            }
        });
    }
    ...
    public static boolean publishInstallAndWait(final Context context,
        ...
        try {
            ...
            String attributionId = Settings.getAttributionId(context
                    .getContentResolver());
            ...
            if (lastPing == 0 && attributionId != null) {
                ...
                Request pingRequest = Request.newGraphPathRequest(null,
                        applicationId, null);
                pingRequest.setParameters(supportsAttributionParams);
                
                GraphObject supportResponse = pingRequest.executeAndWait()
                        .getGraphObject();
                Object doesSupportAttribution = supportResponse
                        .getProperty(SUPPORTS_ATTRIBUTION);
                ...
                if ((Boolean) doesSupportAttribution) {
                    ...
                    publishParams.setProperty(ANALYTICS_EVENT,
                    ...
                    Request publishRequest = Request.newPostRequest(null,
                            publishUrl, publishParams, null);
