...
final class NativeProtocol {
    ...
    static final String KATANA_SIGNATURE = "30820268308201d102044a9c4610300d06092a864886f70d0101040500307a310"
    ...
    static Intent createProxyAuthIntent(Context context, String applicationId,
            List<String> permissions) {
        Intent intent = new Intent().setClassName(KATANA_PACKAGE,
                KATANA_PROXY_AUTH_ACTIVITY).putExtra(
                KATANA_PROXY_AUTH_APP_ID_KEY, applicationId);
        
        if (!Utility.isNullOrEmpty(permissions)) {
            intent.putExtra(KATANA_PROXY_AUTH_PERMISSIONS_KEY,
    ...
    static Intent createLoginDialog20121101Intent(Context context,
        ...
        Intent intent = new Intent()
                ...
                .putStringArrayListExtra(EXTRA_PERMISSIONS,
    ...
    private static ArrayList<String> ensureDefaultPermissions(
    ...
    static boolean isServiceDisabledResult20121101(Intent data) {
        ...
        return ((PROTOCOL_VERSION_20121101 == protocolVersion) && ERROR_SERVICE_DISABLED
                .equals(errorType));
    }
