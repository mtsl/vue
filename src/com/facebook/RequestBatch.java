...
public class RequestBatch extends AbstractList<Request> {
    ...
    private final String id = Integer.valueOf(idGenerator.incrementAndGet())
            .toString();
     ...
     *            the timeout, in milliseconds; 0 means do not timeout
     */
    public void setTimeout(int timeoutInMilliseconds) {
        if (timeoutInMilliseconds < 0) {
            throw new IllegalArgumentException(
                    "Argument timeoutInMilliseconds must be >= 0.");
        }
    ...
    public interface Callback {
         ...
         * 
         * @param batch
         *            the RequestBatch containing the Requests which were
         *            executed
         */
