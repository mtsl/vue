...
public class CacheableRequestBatch extends RequestBatch {
    ...
    // If this is set, the provided string will override the default key (the
    // URL) for single requests.
    // There is no default for multi-request batches, so no caching will be done
