...
public class RequestAsyncTask extends AsyncTask<Void, Void, List<Response>> {
    ...
    protected void onPreExecute() {
        ...
        if (requests.getCallbackHandler() == null) {
            // We want any callbacks to go to a handler on this thread unless a
            // handler has already been specified.
    ...
    RequestAsyncTask executeOnSettingsExecutor() {
        try {
            if (executeOnExecutorMethod != null) {
                executeOnExecutorMethod.invoke(this, Settings.getExecutor(),
                        null);
                return this;
            }
