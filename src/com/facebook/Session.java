...
public class Session implements Serializable {
    ...
    void authorize(AuthorizationRequest request) {
        ...
        if (!started) {
            synchronized (this.lock) {
                ...
                default:
                    this.state = SessionState.CLOSED_LOGIN_FAILED;
                    postStateChange(oldState, this.state,
                            new FacebookException("Log in attempt failed."));
                }
            }
        }
    }
    ...
    class TokenRefreshRequest implements ServiceConnection {
        ...
        public void bind() {
            ...
            if (intent != null
                    && staticContext
                            .bindService(intent, new TokenRefreshRequest(),
    ...
    private class AutoPublishAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                Settings.publishInstallAndWait(mApplicationContext,
                        mApplicationId);
            } catch (Exception e) {
    ...
    public static class AuthorizationRequest implements Serializable {
        ...
        AuthorizationClient.AuthorizationRequest getAuthorizationClientRequest() {
            ...
            return new AuthorizationClient.AuthorizationRequest(loginBehavior,
                    ...
                    applicationId, validateSameFbidAsToken, delegate);
        }
