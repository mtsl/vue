...
public class Request {
    ...
    public Request(Session session, String graphPath, Bundle parameters,
        ...
        if (!this.parameters.containsKey(MIGRATION_BUNDLE_PARAM)) {
            this.parameters.putString(MIGRATION_BUNDLE_PARAM,
                    FacebookSdkVersion.MIGRATION_BUNDLE);
        }
    }
    ...
    final String getUrlForBatchedRequest() {
        ...
        if (this.restMethod != null) {
            baseUrl = ServerProtocol.BATCHED_REST_METHOD_URL_BASE
                    + this.restMethod;
        } else {
    ...
    private static void serializeAttachments(Bundle bundle,
    ...
    private static void serializeRequestsAsJSON(Serializer serializer,
            Collection<Request> requests, Bundle attachments)
            throws JSONException, IOException {
